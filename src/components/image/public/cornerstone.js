/*! cornerstone-core - 2.1.1-rc1 - 2018-03-30 | (c) 2016 Chris Hafey | https://github.com/cornerstonejs/cornerstone */
	...
	([
		...
		(function(module, exports, __webpack_require__) {
			...
			function getRenderCanvas(enabledElement, image, invalidated) {
				...
				start = (0, _now2.default)();
//				console.log(1457, 'renderCanvasData', renderCanvasData);
				renderCanvasContext.putImageData(renderCanvasData, 0, 0);
				if(image.originImageNum) {
					var mprOldImageData = renderCanvasContext.getImageData(0, 0, image.width, image.originImageNum);
					var mprNewImageData = renderCanvasContext.createImageData(image.width, image.height);
					bilinearInterpolation(mprOldImageData, mprNewImageData);
					renderCanvasContext.putImageData(mprNewImageData, 0, 0, 0, 0, image.width, image.height);
				}
				image.stats.lastPutImageDataTime = (0, _now2.default)() - start;
			...
			function bilinearInterpolation(imgData, newImgData) {
				...
				function scale(data, width, height, newData, newWidth, newHeight) {
					...
					const filter = function(dstCol, dstRow) {
						// 源图像中的坐标（可能是一个浮点）
		...
		(function(module, exports, __webpack_require__) {
			...
			function generateLinearModalityLUT(slope, intercept) {
				return function(storedPixelValue) {
					//1574
					//	console.log(2345,storedPixelValue);
		...
		(function(module, exports, __webpack_require__) {
			...
			function purgeCacheIfNecessary() {
				...
				while(cacheSizeInBytes > maximumSizeInBytes) {
					...
					(0, _triggerEvent2.default)(_events.events, _events2.default.WEBGL_TEXTURE_REMOVED, {
		...
		(function(module, exports, __webpack_require__) {
			...
			function purgeCacheIfNecessary() {
				...
				while(cacheSizeInBytes > maximumSizeInBytes) {
					...
					(0, _triggerEvent2.default)(_events.events, _events2.default.IMAGE_CACHE_PROMISE_REMOVED, {
						imageId: imageId
					});
				}
		...
		(function(module, exports, __webpack_require__) {
			...
			Object.defineProperty(exports, 'storedRGBAPixelDataToCanvasImageData', {
				enumerable: true,
				get: function get() {
					return _interopRequireDefault(_storedRGBAPixelDataToCanvasImageData).default;
				}
			});
		...
		(function(module, exports, __webpack_require__) {
			...
			exports.default = {
				...
				storedRGBAPixelDataToCanvasImageData: _storedRGBAPixelDataToCanvasImageData2.default,
		...
		(function(module, exports, __webpack_require__) {
			...
			function loadImageFromImageLoader(imageId, options) {
				...
				imageLoadObject.promise.then(function(image) {
					(0, _triggerEvent2.default)(_events.events, _events2.default.IMAGE_LOADED, {
						image: image
					});
				}, function(error) {
					var errorObject = {
